...
void main() {
  ...
  testWidgets(
    'selection delta keeps references and updates selection without rendering',
    (tester) async {
      final calls = <String>[];
  ...
  testWidgets(
    'pixel change defers the snapshot until render and retains common references',
    (tester) async {
      final calls = <String>[];
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(EditorSession.channel, (call) async {
