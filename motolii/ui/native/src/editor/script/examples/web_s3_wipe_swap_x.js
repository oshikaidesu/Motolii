// SANKOU! #3 化合 — the same wipe over moving video (the Web site has a poster + video; here every slide is a clip). The slide on top is clipped away from its right
...
const slides = ["clip1.mp4", "clip2.mp4", "clip3.mp4"];
