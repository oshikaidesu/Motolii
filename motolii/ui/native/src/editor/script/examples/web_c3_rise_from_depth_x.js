...
// OnScrollTextHighlight (js/effect-1/highlightEffect.js): the letters stand up out of depth, one after another.
...
lines.forEach((line, row) => {
  ...
  chars.key("Position Z", at, -700, P2).key("Position Z", at + RISE, 0)
