// SANKOU! #10 — mamamamamamama.com / recruit.toyox.co.jp: a ring of things keeps turning, and things beside it float.
...
const stage = group(...things, ...orbit).name("Stage");
...
orbit.forEach((o) => o.set("Position Type", "Absolute").set("Position", [450, 450]));
