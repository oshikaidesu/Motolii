// SANKOU! #8 化合 — the follower is a video clip and leans the way it is being pulled (Tilt from the lag vector, 2.5D).
// companycoc.com: a thumbnail follows the cursor, late (lerp). Source: targetX = (clientX - centre) * sr,
