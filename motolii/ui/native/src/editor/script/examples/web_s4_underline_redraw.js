// SANKOU! #4 — recruit.toyox.co.jp: on hover the underline leaves to the right and is drawn again from the left.
...
const link = (word, x, y, hover) => {
  ...
  text(word, { name: word }).fill(INK).font("Helvetica Neue").set("Size", SIZE).set("Position", [x + len / 2, y]);
...
link("RECRUIT", 200, 300, 0.5);
link("MESSAGE", 200, 500, 1.4);
link("ENTRY", 200, 700, 2.3);
