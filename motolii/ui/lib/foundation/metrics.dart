...
abstract final class EditorMetrics {
  ...
  static const double micro = 8, dense = 9, font = 10, title = 13;

  /// The box a shelf's kind mark is drawn in; its own size, so a bar that
  /// grows does not move the marks.
  static const double mark = 28;
