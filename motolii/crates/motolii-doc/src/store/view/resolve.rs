...
pub(crate) fn resolve_with_solo(
    ...
    Ok(Some(ResolvedLayer {
        ...
        placement: LayerPlacement {
            ...
            z: scalar(property::POSITION_Z, 0.0)? + view.laid_out(layer, t)?.map_or(0.0, |slot| slot.z),
            rotation_x: scalar(property::ROTATION_X, 0.0)? + view.laid_out(layer, t)?.map_or(0.0, |slot| slot.rotation[0]),
            rotation_y: scalar(property::ROTATION_Y, 0.0)? as f32 + view.laid_out(layer, t)?.map_or(0.0, |slot| slot.rotation[1]),
            plane: None,
        },
        declared_size: size,
        source: meta.source,
        ...
        averaged: 0,
        shape_stretch: view.laid_out(layer, t)?.map_or([1.0, 1.0], |slot| slot.stretch),
