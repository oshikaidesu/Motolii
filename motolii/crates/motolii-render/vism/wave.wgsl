/*{
  ...
  "LABEL": "Wave",
  "STAGE": "block",
  "DESCRIPTION": "Moves each thing up and down on a sine wave that travels along them in order (Cavalry's Wave behaviour; AE's wiggly text selector made regular)",
  "INPUTS": [
...
fn block(k: u32, p: BlockParams) -> Offset {
    ...
    return Offset(vec2f(0.0, p.amplitude * sin(phase)), 0.0, 1.0);
}
