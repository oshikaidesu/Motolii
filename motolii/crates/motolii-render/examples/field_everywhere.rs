...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for (name, amount, world) in [("world-still", 0.0, false), ("world-moved", 70.0, false), ("world-linked", 70.0, true)] {
        ...
        doc.apply(Intent::SetComposition(Composition { width: W, height: H, fps: Fps::try_new(30, 1).unwrap(), duration_frames: 1, background: [0.07, 0.07, 0.09, 1.0], look: Default::default() }))?;
