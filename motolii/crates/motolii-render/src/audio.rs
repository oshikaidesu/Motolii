...
pub use convert::{canonical_format, time_to_canonical_frames, CANONICAL_CHANNELS, CANONICAL_SAMPLE_RATE};
pub use decode::{decode_file, decode_file_audio_ordinal, MAX_SAMPLES};
...
pub use program::{file_source_can_have_audio, program_from_sources, AudioProgram, AudioProgramCache};
