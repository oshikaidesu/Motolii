//! 字組み — 字を並べて輪郭にする。書体の面倒も見る(cosmic-text)。
//! 組み方の設定(`TextLayout`・`HangingPunctuation` など)は書類の値なのでコアに残る。

use cosmic_text::fontdb;
use cosmic_text::{Align, Attrs, Buffer, Command, Family, FeatureTag, FontFeatures, FontSystem, Metrics, Shaping, SwashCache};

pub use crate::doc::vector::text::*;
