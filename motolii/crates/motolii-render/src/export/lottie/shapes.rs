...
use crate::doc::vector::{Brush, Contour, Dash, Fill, OpKind, PathSource, StarType, Stroke};
...
fn gradient_colors_json(stops: &[crate::doc::vector::GradientStop]) -> serde_json::Value {
