...
pub struct EffectPass {
    ...
    /// `image_time_offsets` と同じ並び: 時刻の読み方(t からの秒 / 層の入点からの秒 / t からのコマ数)。
    pub(crate) image_time_bases: Vec<isf::TimeBase>,
...
impl EffectPass {
    ...
    pub fn image_time_base(&self, i: usize) -> isf::TimeBase {
        self.image_time_bases.get(i).copied().unwrap_or_default()
    }
