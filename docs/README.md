...
| [specs/](specs/README.md) | マイルストーン仕様書(エージェントへの発注書)。確定/ドラフトのステータスはspecs/README.md参照 | M0/M1確定、**M2ドラフト(発注停止 — [ゲート停止メモ](reviews/2026-07-12-M2-order-gate-halt.md))**、M3〜M5ドラフト |
