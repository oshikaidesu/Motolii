...
4. M3実装に着手する時: [m3-parallel-implementation-map.md](m3-parallel-implementation-map.md)(親検索→子target/oracle/衝突)→ [implementation-ledger.md](implementation-ledger.md)(実際にdispatchする`DO`)→ [specs/M3-ui-integration.md](specs/M3-ui-integration.md)(意味と実装ガード)
