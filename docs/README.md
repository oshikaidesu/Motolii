...
| [m5-known-implementation-adoption-map.md](m5-known-implementation-adoption-map.md) | M5の10機構class、公式source固定点、暫定route、11実装子、decision recovery順序 | **調査完了／暫定採択地図**(2026-08-02。製品runtime未許可) |
