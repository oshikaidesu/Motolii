...
| [m5-known-implementation-adoption-map.md](m5-known-implementation-adoption-map.md) | M5の10機構class、採択route、12実装子、この隔離branchでの検証契約、decision recovery順序 | **技術採択決定／A1・R0検証DONE／残り検証NEXT**(2026-08-02。製品runtimeは意味decision・evidence gate待ち) |
