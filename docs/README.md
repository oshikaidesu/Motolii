...
- **Rerun wrapperとM3 bring-up（2026-08-11）**: RN、Rerun、Skiaが共存する`ui/motolii-rn/`をその場で製品化する。Document評価をRerun入力へ薄く翻訳し、結果を同じStageへ載せ、確定操作だけD2へ戻す。`ui/motolii-rn-legacy/`はread-onlyの旧製品shellであり、probeからのcopy、direct `re_renderer` scene、shape別frame、第二Host／writer／GPU／UIを作らない。正本は[Rerun採択再締結](reviews/2026-08-10-m5-rerun-spatial-viewer-adoption-reclosure-decision.md)、[共同開発bring-up](reviews/2026-08-10-m3-collaborative-bringup-decision.md)、[Stage Hero](reviews/2026-08-11-m3-m5-stage-hero-projection-root-decision.md)
