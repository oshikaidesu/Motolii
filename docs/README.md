...
- **現在のUI接続粒（2026-07-29）**: [G0-6H人間審判](reviews/2026-07-29-g0-6h-human-acceptance-decision.md)はUI作者の`ACCEPT`で完了した。[CU-0B02T](reviews/2026-07-29-cu-0b02t-product-token-authority-implementation-decision.md)でDark token authorityを閉じ、token後続を`WAIT`へ戻した。[CU-0A08BTI](reviews/2026-07-29-cu-0a08bti-browser-place-typed-intent-implementation-decision.md)でRectangle Browser dragをtyped Host callbackへ接続した。次PRODUCT-ASSET `DO`はHost接続契約`CU-0B03H`
