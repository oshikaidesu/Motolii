...
| [reviews/2026-07-24-dependency-first-responsibility-gate.md](reviews/2026-07-24-dependency-first-responsibility-gate.md) | スクラッチの局所最短でOS差・保守・試験等の問題外責任を抱えず、再利用・依存・wrap・外部runner・自作を総責任で裁く着手前動線 | **決定**(全実装粒の責任処分。候補libraryは未採択) |
