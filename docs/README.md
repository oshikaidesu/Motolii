...
| [reviews/2026-07-21-m3-u1a-1-static-viewport-contract.md](reviews/2026-07-21-m3-u1a-1-static-viewport-contract.md) | U1a-1の単一Document→display閉路、register-once、event-loop前setup、製品window lifecycle、中央Stage境界 | **実装前契約**(旧night差分は直接統合せず、本契約から再実装。実monitor DPI移動はU1e) |
