...
| D1l | `READY` | Definition/Use分離、ordered stack、inline migration、非隣接共有、GAP-14 lifecycle不変条件 | Issue化してschema/migration実装 | GAP-14決定済。次にIssue化可 |
