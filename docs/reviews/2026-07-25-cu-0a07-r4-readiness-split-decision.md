...
- 日付: 2026-07-25
- 状態: **決定**
- 現在粒: **R4系完了（CU-0A07C / R4Cは[#357](https://github.com/oshikaidesu/Motolii/pull/357)で`DONE`）**
- 後続: **CU-0A08Iは`READY-RECHECK`でHost projection粒の再判定待ち（R4系は閉じた）**
...
| CU-0A07C | `DONE` | [#357](https://github.com/oshikaidesu/Motolii/pull/357): R4BのJSX/CSSをbyte同一でproduct ownerへ移し、mockをconsumerへ反転 | CU-0A07B |
