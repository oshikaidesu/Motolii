...
| [2026-07-29-m5-render-contribution-evidence-wave.md](2026-07-29-m5-render-contribution-evidence-wave.md) | M5 P2D周辺の共通Host境界、固定語彙／引用anchor、code fact、共通非目標を一度だけ固定し、旧RCA/B/Cを停止して取得／転記／比較／裁定を別粒へ分ける親task |
...
| [2026-07-29-m5-provider-fixture-map-v5.md](2026-07-29-m5-provider-fixture-map-v5.md) | P2D-RCC5のACCEPT済み三provider観察とMotolii fixture候補の固定fragment配置template |
| [2026-07-29-m5-render-contribution-boundary-map-v4.md](2026-07-29-m5-render-contribution-boundary-map-v4.md) | P2D-RCA4のMotolii境界固定fragment ID配置template |
...
| [2026-07-29-m5-render-contribution-conformance-harness-decision.md](2026-07-29-m5-render-contribution-conformance-harness-decision.md) | P2D-RCF1。provider中立black-box harness、F1〜F6分担、First Vism無特権条件を閉じるdecision |
