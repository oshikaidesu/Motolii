...
| [2026-07-27-vism-authoring-journey-decision.md](2026-07-27-vism-authoring-journey-decision.md) | 推奨pass shape／標準operation候補と独自WGSL、Text／Path／Motion作者入口、typed identity、自己完結shader／asset closure、既知資産のauthoring時import、代表Vismを反例probeへ分ける昇格条件を扱う作者journey比較 |
