...
- **[M2発注ゲート停止](2026-07-12-M2-order-gate-halt.md)** — 2026-07-12。入場≠確定の取り違え訂正。D1a/D1b/D3完了撤回。D1d/D2/D4/D5/D6/M3 新規発注禁止
- [D1スキーマ未決点の先例調査](2026-07-12-d1-spec-holes-prior-art.md) — TimeMap/キーフレーム/bpm/Asset指紋等。**D1a/D1b「完了」は撤回**(再開)。決定昇格済みの節と未決表を併読
- [M2入場条件](2026-07-11-M2-entry-gate.md) — **達成**(Document入場)。**M2仕様確定・並列発注解禁を意味しない** — 停止メモ参照
- [M3/M4候補台帳](2026-07-12-M3-M4-gate-ledger.md) — M3発注は M2 再確定まで禁止
