...
> 2026-07-23歴史監査: cutoff全2版を[Unit 4L回収](2026-07-23-historical-d1l-constructor-lint-lineage-recovery.md)で処分した。本決定は採択済みだが、現行codeは`#[deprecated]`と25箇所の`allow(deprecated)`を残し、`#[doc(hidden)]`へ未移行である。green lintを完了証拠にせず、GAP-23で狭い実装修復を再開する。
