...
2026-07-21の[wgpu 29 surface host実機spike](../spikes/g0-9-surface-host.md)で、macOSのresize 100回、
minimize/restore、fullscreen進入時描画、nativeからWebViewへの境界drag、readback 0は合格した。以下は
全platform受入一覧として
残し、この部分合格から異DPI、逆方向drag、lost、IME、a11y、Windowsへ外挿しない。
