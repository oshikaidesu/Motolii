...
| VSM-B7 | 第三者分散並列fixture。無関係な複数作者／namespace／version／fork capabilityを同時解決する意味表 | VSM-A9, VSM-B0〜B5 | identity衝突、欠落、非互換、循環、permission拒否を局所化。片方の失敗で他Vism／原本／無関係編集不変。first-party特例0。registry／署名方式はまだ固定しない | VSM-A9/B5待ち |
