...
1. **VSM-A4**: first-party無特権gateを仕様へ昇格し、外部crate証拠を個別testの慣習から共通CI契約へする。A4SとA4Iは実装・機械oracleまで完了し、独立reviewとmain統合が残る。
