...
| LANG-TS-F0 | [言語境界決定](2026-08-01-vism-authoring-language-boundary-decision.md)のMTS-1意味・診断fixtureをheadless dev harnessで閉じる。live engine／製品UI／Documentは触らない | 言語境界決定、VSM-A4S | ECMAScript 2024＋TypeScript 7.0.2基線、closed allowlist、Host SDK型、typed recipe同値oracle、MTS-N1〜N5/N7/N9、典型error 8/10、10分forkを固定。compilerは隔離authoring toolchain入力に限定し、製品runtime／Cargo依存、serde、package、loaderを追加せず、製品対応を称さない | **WAIT／A4Sの独立review後に仕様粒化** |
