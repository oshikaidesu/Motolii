...
| 処分済み（Unit 1 + 2A + 2B + 2C + 3A + 3B-UI + 3B-runtime-A/B1/B2-A + 3C + 4A + 4B + 4C-1/2/3 + 4D + 4E + 4F + 4G + 4H + 4I + 4J + 4K + 4L + 4M + 4N + 4O + 4P + 4Q + 5A + 5B + 5C + 5D + 5E + 5F + 5G + 5H + 5I + 5J + 5K + 5L + 5M + 9A + 9B + 9C + 9D + 9E） | 420 |
| 未処分 | 1,377 |
