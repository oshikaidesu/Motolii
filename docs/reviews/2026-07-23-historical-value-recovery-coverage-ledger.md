...
| 処分済み（Unit 1 + 2A + 2B + 2C + 3A + 3B-UI + 3B-runtime-A/B1/B2-A + 3C + 9A + 9B + 9C） | 201 |
| 未処分 | 1,596 |
...
| 9D | A3 external expression／Radial Repeater／LayerSource lowering lineage | 未着手 |
| 9E | catalog、distribution、third-party install/load/trustの他path残余lineage | 未着手 |
