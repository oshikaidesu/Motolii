...
| 処分済み（Unit 1 + 2A + 2B + 2C + 3A + 3B-UI + 3B-runtime-A/B1） | 112 |
| 未処分 | 1,685 |
...
| 3B-runtime-B2 | native/WASM、公開能力、first/third-party runtimeの横断残余 | 未着手 |
| 3C | FrameDescとplugin-facing共有型のlineage | 未着手 |
