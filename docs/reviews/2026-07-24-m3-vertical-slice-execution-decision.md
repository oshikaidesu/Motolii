...
| Browser catalog projection | CU-G09 DONE / CU-G09O DO | Rectangleを含むcardの型付きread modelとunknown/dangling拒否 | [CU-G09 Browser catalog projection契約決定](2026-07-26-cu-g09-browser-catalog-projection-contract-decision.md)で受理入力・identity・`B1`〜`B12`を閉じたが、CU-0A08BP事前審査でdecoder出力shapeと型gate未決を検出した。docs-only CU-G09Oを次粒とし、CU-0A08BPは追補完了待ち。`CU-0A08BT`はCU-0A08BP + U4a-2待ち |
