...
| Browser catalog projection | CU-G09 DONE / CU-G09O DONE / CU-G09R DO | Rectangleを含むcardの型付きread modelとunknown/dangling拒否 | [CU-G09 Browser catalog projection契約決定](2026-07-26-cu-g09-browser-catalog-projection-contract-decision.md)で受理入力・identity・`B1`〜`B12`を閉じ、[CU-G09O Browser decoder output契約決定](2026-07-26-cu-g09o-browser-decoder-output-contract-decision.md)でdecoder出力shape・`O1`〜`O6`・`B11`/`B12`改訂・`B13`/`B14`を閉じた。CU-0A08BP v3事前審査で拒否familyの重複・未割当を検出したため、次PRODUCT-ASSET粒はdocs-only `CU-G09R`（`DO`）。`CU-0A08BP`はCU-G09R待ち、`CU-0A08BT`はCU-0A08BP + U4a-2待ち |
