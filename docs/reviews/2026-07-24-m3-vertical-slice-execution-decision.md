...
| selection / Undo再投影 | CU-104 DONE / U2h-1S DONE / CU-104E DONE / U2h-1I DONE | commit/Undo/Redo後にTransient selectionと三面投影をどう更新するか | `CU-104`は[selection publish envelope決定](2026-07-27-cu-104-selection-publish-envelope-decision.md)を`DONE`とし、docs-only `U2h-1S`、docs-only `CU-104E`、実装粒`U2h-1I`も`DONE`。PRODUCT-ASSET laneの次実装粒はselection-only入力面の`U2h-1P`。owner・visibility・`projection_generation`更新条件・枯渇preflight・Apply/Undo/Redo後publish前reconcile時点は閉じ済みで、selectionをDocumentへ保存しない。U2h-1Pではprivate `ReplacePrimary`／`ClearPrimary`とP5だけを閉じ、CU-109/110/111/106へ拡大しない。完了証拠: [U2h-1 primary selection implementation split決定](2026-07-27-u2h-1-primary-selection-implementation-split-decision.md)、[CU-104E projection generation枯渇境界決定](2026-07-27-cu-104e-projection-generation-exhaustion-decision.md) |
