...
- [ ] **1. エクスポート中断でmp4が壊れる** — `crates/oc-export/src/lib.rs:89`
...
- [ ] **2. 一度のGPUエラーで恒久故障** — `crates/oc-gpu/src/ctx.rs:213`
...
- [ ] **3. プロジェクトJSONの負のstart_frameでpanic** — `crates/oc-export/src/lib.rs:48`
...
- [ ] **4. 毎フレームのシェーダ/パイプライン再生成** — `crates/oc-nodes/src/lib.rs:186,232,373,392`
...
- [ ] **10. パイプライン形状が2本番経路で重複** — `crates/oc-render/src/lib.rs:148-160 vs 207-228`
