...
日付: 2026-07-16
状態: **実装発注の正本**。意味は[UI操作言語](../ui-interaction-language.md)と[UI視覚言語](../ui-visual-language.md)、境界は[M3 UI境界汚染の予防](2026-07-14-m3-ui-boundary-prevention.md)に従う
...
5. `U1a-1`は最新mainから起票し、静止viewport以外を混ぜない
