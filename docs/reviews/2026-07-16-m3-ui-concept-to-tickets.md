...
|---|---|---|---|---|
| U0e-1 | [決定済みDTCG token schema](2026-07-21-m3-u0e-1-token-generator-contract.md)と決定的Rust/egui adapter generator | U0a。PR #184は証拠・抽出元 | 同じ入力からbyte一致、生成物の手編集差分を拒否 | 色、px、radius等の**製品値を確定しない** |
