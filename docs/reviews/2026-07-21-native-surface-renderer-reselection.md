...
2026-07-24追補: このA/Bはprimitiveと局所Velloの責任境界を確かめるisolated capability
spikeであり、同じtext/icon量を要求するG0-9L L1の比較armではない。G0-9Lは
[L1正本修正](2026-07-24-m3-g0-9l-l1-measurement-amendment.md)に従い、A+Bの製品候補stack
全体とegui baselineを比較する。AだけをL1第三armへ流用せず、本節の未実施項目を
CU-0G02またはCU-0G02Bの合格へ読み替えない。
