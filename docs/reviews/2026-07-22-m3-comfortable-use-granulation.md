...
| CU-0A07B | `ASSET / DO` | 固定mock内でInspectorを同形React化しlegacy adapterを封じる | CU-0A07A | exact-count containment、双方向store 0、skeleton代用0 | handlerを一方向adapterへ封じられない |
...
- U0e-2R/U0e-2、CU-0A03/R0、CU-0A04/R1、CU-0A05A/R2A、CU-0A05B/R2B、CU-0A06A/R3A、CU-0A06B/R3B、CU-0A07S/R4S、CU-0A07A/R4Aは完了済みで再実行しない。現在粒は`CU-0A07B / R4B Inspector mock React化`の`DO`で、R4C以降とMotolii Studio Previewは未実装である
