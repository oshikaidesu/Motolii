...
| CU-0A07 | `ASSET / READY-RECHECK` | R4 Inspectorを固定mock内で同形React化して移管 | CU-0A06B | legacy parity後に単一owner、skeleton代用0、legacy runtime import 0 | 正しい同形componentを作れず意味発明が必要 |
...
- U0e-2R/U0e-2、CU-0A03/R0、CU-0A04/R1、CU-0A05A/R2A、CU-0A05B/R2B、CU-0A06A/R3A、CU-0A06B/R3Bは完了済みで再実行しない。現在粒は`CU-0A07 / R4 Inspector`の`READY-RECHECK`であり、R4以降とMotolii Studio Previewは未実装である
