...
| CU-205B2 | `PRODUCT-ASSET / DO` | Rust Host snapshotとshipped bundle接続 | CU-205B1I | first_party_catalog由来、正規bundle/manifest/include、通常製品表示 | contract複製、source意味変更、generatedだけ手修正 |
