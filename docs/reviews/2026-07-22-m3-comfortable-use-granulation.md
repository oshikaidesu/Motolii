...
| CU-0A08BTP | `PRODUCT / DO` | decoded Rectangle identityのproduct component入力→private JSX透過 | CU-0A08BP、CU-0A08RS、CU-0A08SSCI-P1/I/T1 | Rectangle 1件、非推測、runtime caller/Host wire/intent 0 | mock/dev producerまたはidentity推測が必要 |
