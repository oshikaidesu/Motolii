...
| CU-0A08BP | `CORE / DO` | CU-G09/CU-G09O準拠のproduct-owned・非export pure Browser catalog decoder | CU-0A04、CU-G09、CU-G09O | strict revision、unknown/non-finite/oversized/dangling/§6a禁止key拒否、React semantic write 0 | `S`行、drag payload、Host transport、JSX bindingが必要 |
