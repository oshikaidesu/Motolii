...
| CU-0B05 | `E2E / DO` | reload/crash/focus/resize後にHost snapshotから再投影 | CU-0B04N/R、CU-0B05S | 同じrevision/selection、old epoch拒否、Document/history不変 | surface間state同期が必要 |
