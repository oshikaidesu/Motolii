...
| CU-205B1I | `PRODUCT-ASSET / DO` | Web source strict catalog consumer + provenance append | CU-205B1G | codec→existing decoder→main→PluginCard、mock 3 card不変、Rust/bundle/intent 0 | fallback/default/Context、provenance欠落 |
