...
| CU-104 | `SPEC / DO` | U2h selection publish/Undo/Redo policyを決定 | CU-G02/03 | Document snapshotと整合したTransient selection envelope。owner・visibility・`projection_generation`更新条件・Apply/Undo/Redo後publish前reconcile時点だけをdocsで閉じる | selectionをDocument/journal/Undoへ保存、またはU2h-1/CU-109/CU-110/CU-111/consumer実装を束ねたくなる |
