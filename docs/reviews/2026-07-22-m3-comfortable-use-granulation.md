...
| CU-0B03 | `PRODUCT / DO` | H1b exact codecをnative Host inboxへ接続 | CU-0B03H | invalid/stale/duplicate/oversize拒否、callback内D2 0、bounded inbox | WebView transportを公開plugin APIへ一般化したくなる |
