...
| CU-205T | `PRODUCT / DO` | Opacity double click/Enter→primaryへ新Definition+Use | CU-205B2、VS-1 D2 | `prepare_create_effect`、明示default、1 attach=1 Undo、primaryなしwrite 0 | LinkEffectUse共有、bare item ID、Stage全体をtarget化 |
