...
| CU-0B03H | `SPEC / DO` | H1b offline bundle / closed Host callback / mountの最小契約を固定 | CU-0A09B、CU-0A08BTI | built-in Browser 1面、network 0、fixture caller 0、公開plugin API 0 | package/version/role/wire上限を歴史値から復活させたくなる |
