...
Motoliiは、持ち運べる映像表現Vismを実行・編集する最初のHostであり、クリエイターの感覚的な意図を、軽量で再現可能な画へ翻訳する。2026-07-22以降、「演奏」は製品全体を音楽へ寄せるため使わない([撤回記録](2026-07-22-ui-music-metaphor-retirement.md))。
