...
| VISUAL-RESPONSE | G0-6H-V1ETB | M3 evidence / VS-1 / Browser projected Media face | `DO` | — | `G0-6H-V1ETB-Q`は[発注依存証跡](#発注依存証跡)で`DONE` | Browser seam、R-9、post-promotion provenance/guardをrouteで閉じる |
