...
| PRODUCT-ASSET | CU-201S | M3 / VS-2 / SPEC / U3b responsibility split | `DONE` | [CU-201S責任分割](reviews/2026-08-01-cu-201-u3b-move-trim-snap-responsibility-split-decision.md) | CU-105R/U3a-1I projection/hit、CU-106P primary、single writerを再照合 | M-S/M-C完了。次はdocs-only T-S |
