...
| PRODUCT-ASSET | CU-102 | M3 / VS-1 / SPEC / fresh LayerId + AddTrackItem atomicity | `DO / SPEC` | — | `CU-101`と`CU-G03`はDONE。歴史回収§3.1と既存D2/LayerIdTable/AddTrackItemへ照合 | live-next検査、失敗時counter/history/revision不変、journal互換だけを決定。CU-110実装を束ねない |
