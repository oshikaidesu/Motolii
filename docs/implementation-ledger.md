...
したがって現在の短い運用判断は、**M2基盤再締結とD3e、D1m、CAM-G0、D1j、D1k-S、D1k、D3fは完了済みで、M3製品実装はまだ発注しない**。D5は骨格を完了扱いせず、本番preview／GPU計測／実機E2Eを後続へ残す。次のM3入場PRでU0b/U1a/U0e等の採否と依存を再確定する。
