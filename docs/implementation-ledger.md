...
| M5 | **`M5-A0T` / `M5-A1` DONE / R0/T0/P0/I0/D0検証NEXT / `M5-A0S` WAIT** | [M5-A1 receipt](reviews/evidence/m5-known-implementation/M5-A1/README.md)で`gltf 1.4.1`／`mikktspace 0.3.0`をprivate leafとしてKEEPした。typed負例6/6、Khronos core positive 156/156、required-extension 15件分離を確認し、negative 14件をparserが受理するためValidatorを必須外部oracleとして維持する。製品依存、Importer、faithful asset、3 OSは未実装。次はR0/T0/P0/I0/D0を一粒一commitで検証し、runtime前に`M5-A0S`、Observation、M4 resource gateを閉じる |
