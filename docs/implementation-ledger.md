...
| PRODUCT-ASSET | CU-110 | M3 / VS-1 / CORE / Place D2 commit connection | `DO` | [CU-107親閉鎖決定](reviews/2026-07-29-cu-107-place-coordinator-parent-closure-decision.md) | CU-102 + CU-107 + CU-109 `DONE` | valid dropでfresh ID、AddTrackItem/apply_macro各1、cancel/失敗0 |
