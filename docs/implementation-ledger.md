...
| VISUAL-RESPONSE | G0-6H-V1ETB | M3 evidence / VS-1 / Browser projected Media face | `DO` | — | `G0-6H-V1ETB-P`完了と[本粒decision doc](reviews/2026-07-28-g0-6h-v1etb-p-browser-projection-consumer-capsule-boundary-decision.md) | Browser seam、R-9、post-promotion provenance/guardをrouteで閉じる |
