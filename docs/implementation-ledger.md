...
| PRODUCT-ASSET | CU-0A08SSCI-I | M3 / VS-1 / SPEC / Browser scoped identity input seam contract shape adjudication | `DO` | [CU-0A08SSCI-I0採番](reviews/2026-07-29-cu-0a08ssci-i0-browser-scoped-identity-input-seam-grain-numbering-decision.md) | `CU-0A08SSCI-I0`は[発注依存証跡](#発注依存証跡)で`DONE` | 最小private input seamの契約形をdocs-onlyで裁定。code・型・props名・公開境界変更0 |
