...
| VISUAL-RESPONSE | G0-6H-V1ETB | M3 evidence / VS-1 / Browser projected Media face | `DO` | — | `G0-6H-V1ETB-H`完了と[新規decision doc](reviews/2026-07-28-g0-6h-v1etb-h-browser-post-promotion-authority-reclosure-decision.md) | Browser seam、R-9、post-promotion provenance/guardをrouteで閉じる |
