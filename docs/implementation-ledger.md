...
| VISUAL-RESPONSE | G0-6H-V1G-I | M3 evidence / VS-1 / current-route manifest and fingerprint infrastructure | `DO` | — | `G0-6H-V1G-P`は[発注依存証跡](#発注依存証跡)で`DONE` | manifest v2と共有source fingerprint基盤だけを閉じる |
