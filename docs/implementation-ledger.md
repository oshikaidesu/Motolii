...
| CORE | U4b-0 | M3 / VS-2 / Add Position Key prerequisite | `SPLIT` | [U4b-0 closed contract](reviews/2026-08-02-u4b0-add-position-key-closed-contract-decision.md) | S → C → product connection | raw allocator / SetProperty、solver複製、Auto Key 0 |
...
| CORE | U4b-0C | M3 / VS-2 / Add Position Key command and prepare | `DO` | [U4b-0 closed contract](reviews/2026-08-02-u4b0-add-position-key-closed-contract-decision.md) | `motolii-eval` split + `motolii-doc` command/prepare/tests | one ID、one Undo、curve不変、v2 replay |
