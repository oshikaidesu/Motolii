...
| PRODUCT-ASSET | CU-109 | M3 / VS-1 / SPEC / edit durability runtime wiring | `DO` | — | `CU-109SP`／`CU-109SP-R1`は[発注依存証跡](#発注依存証跡)で`DONE` | P1。acceptance evidenceはApply roundtripに限定。Undo/Redo durable/poison/journal/reconcile/publish配線はCU-109所有 |
