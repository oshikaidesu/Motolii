...
| VISUAL-RESPONSE | G0-6H-V1EB | M3 evidence / VS-1 / Browser development projection | `DO` | — | `G0-6H-V1R` R-7/R-9/R-11 | product Browserのdevelopment projectionとprovenance/guard再締結だけを閉じる |
| VISUAL-RESPONSE | G0-6H-V1ET | M3 evidence / VS-1 / mock empty projection and ready oracle | `WAIT` | — | `G0-6H-V1EB`完了待ち | Vite mode carrier、Stage/Inspector/Timeline空投影、ready oracleを閉じる |
