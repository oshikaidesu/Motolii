...
| VISUAL-RESPONSE | G0-6H-V1G-C | M3 evidence / VS-1 / current-route offline capture | `DO` | — | `G0-6H-V1G-C-P`が[発注依存証跡](#発注依存証跡)で`DONE` | 2 mode、5 normal、派生variant、provenance、offline captureを閉じる |
