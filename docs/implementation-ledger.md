...
| VISUAL-RESPONSE | G0-6H-E | M3 evidence / VS-1 / candidate approval evidence intake | `DO` | — | `G0-6H-E0`は[発注依存証跡](#発注依存証跡)で`DONE` | 現行候補normal色5画面への肯定的応答だけを記録。G0-6H/CU-0B01/U0e-3状態変更0 |
