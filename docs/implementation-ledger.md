...
| PRODUCT-ASSET | CU-110PT | M3 / VS-1 / PRODUCT / native Timeline published snapshot projection | `DO` | — | `CU-110PS` + U3a-1I/U3a-2A | 既存headless projectionのnon-test callerとnative bar描画。selection入力、React Timeline 0 |
