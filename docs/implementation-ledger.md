...
| 3 | GR-D2 | M3 guard | `DO` | — | GR-D1完了。変更許可閉集合、永続検収証跡、timeout分離、検収者mutation拒否を実装 | GR-R1/R2をDOへ移す |
...
したがって現在の短い運用判断は、**M2基盤再締結とD3e、D1m、CAM-G0、D1j、D1k-S、D1k、D3f、M3 U0a、U0b-1、U0b-2、U0c-1、U0c-2、U0d-1、U0d-2、U0d-3、U2a-0、U2a-1、U1a-1、U1a-2、U1b-1、U1b-2、U2b-1、U2c-1、U2c-4、U0e-1、U0e-2R、GR-D1は完了済み**。次は`GR-D2`だけを進め、GR-D1〜R3の各粒を検収済みにしてから`U0e-2`を再開する。`U2c-2`はU4a-2/U4cの実製品入口待ちとする。Rerunのcommit固定source監査と資産分類は可能だが、現在のUシリーズ実装と並走させない。D5は骨格を完了扱いせず、本番preview／GPU計測／実機E2Eを後続へ残す。
