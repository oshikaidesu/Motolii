...
| PRODUCT-ASSET | CU-107W | M3 / VS-1 / SPEC / CU-107 W0 mirror rewrite | `DO` | — | `CU-107N`は[発注依存証跡](#発注依存証跡)で`DONE` | W0 表と `CU-110` 依存リストを本閉集合の名前へ書き換える裁定（docs-only） |
