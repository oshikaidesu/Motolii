...
| VISUAL-RESPONSE | G0-6H-V1ETC | M3 evidence / VS-1 / carrier and Host empty projection | `DO` | — | `G0-6H-V1ETA` A-2/A-3 | Vite mode channel、legacy script抑止、Inspector / Stage空投影と専用Playwrightを閉じる |
| VISUAL-RESPONSE | G0-6H-V1ETB | M3 evidence / VS-1 / Browser projected Media face | `WAIT` | — | `G0-6H-V1ETC`完了待ち | Browser seam、R-9、post-promotion provenance/guardをrouteで閉じる |
