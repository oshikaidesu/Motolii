...
| AUTHORING-SDK | SDK-S0I | Vism / language-neutral Path2D semantic fixture implementation | `ACTIVE` | — | consumer-neutral JSONとRust test consumerを実装。positive 4、negative 7、contract projection、reason＋target診断、native oracle同値を検査。Grok `ACCEPT` P0=0/P1=0/P2=0、main未到達 | main到達後にLANG-TS-F0を仕様粒化する。製品runtime／Document／公開APIは未成立 |
