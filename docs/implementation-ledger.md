...
| CORE | U4b-1C | M3 / VS-2 / outgoing Interp command and active interval | `DO` | [U4b-1 outgoing Interp契約](reviews/2026-08-02-u4b1-outgoing-interp-command-contract-decision.md) | `motolii-doc` command/prepare + `motolii-ui` read projection + oracle | 1 command/Undo、key payload不変、stale atomic拒否、JournalEdit v2 |
