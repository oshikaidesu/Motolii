...
| PRODUCT-ASSET | CU-110PI | M3 / VS-1 / PRODUCT / Inspector published snapshot identity projection | `DO` | — | `CU-110PT` + CU-0A08IP/CU-0A08ITP | product-owned Inspectorへ同じprimary identityをread-only投影。mock state、S値、typed editing intent 0 |
