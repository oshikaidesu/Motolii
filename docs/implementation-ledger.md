...
| VISUAL-RESPONSE | G0-6H-V1G | M3 evidence / VS-1 / current-route immutable generation | `DO` | — | `G0-6H-V1ETE`は[発注依存証跡](#発注依存証跡)で`DONE` | 5 normal / 30 PNG、別root manifest、offline capture、read-only照合を閉じる |
