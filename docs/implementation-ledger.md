...
| PRODUCT-ASSET | CU-107N | M3 / VS-1 / SPEC / CU-107 narrow prerequisite closed set | `DO` | — | `CU-107R`は[発注依存証跡](#発注依存証跡)で`DONE` | 狭い名前付き前提の閉集合と個数の裁定（docs-only） |
