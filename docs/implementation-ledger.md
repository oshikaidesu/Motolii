...
| GR-D7 | `DONE` | [履歴較正によるLLM役割選択](reviews/2026-08-03-history-calibrated-llm-role-selection-decision.md)でClaudeを意味・owner・契約閉鎖、Grokをscope・exact target・負例・実diff列挙、Sparkを閉じた機械施工へ対応付けた。同familyの設計相談と最終review重複を拒否し、固定route・score DB・retry状態機械は作らない |
