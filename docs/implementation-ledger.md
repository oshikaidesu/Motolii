...
| PRODUCT-ASSET | CU-0B05 | M3 / VS-1 / E2E / Browser Host snapshot lifecycle reprojection | `DO` | [CU-0B04R実装決定](reviews/2026-07-29-cu-0b04r-browser-island-focus-geometry-implementation-decision.md) | CU-0B04N + CU-0B04R。初回instance ready seamまで成立 | reload/crash/focus/resize後に同じrevision/selectionを再投影し、old instance epoch拒否。surface間state同期、Document/history変更 0 |
