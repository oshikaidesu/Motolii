...
| VISUAL-RESPONSE | G0-6H-V1G | M3 evidence / VS-1 / current-route immutable generation | `SPLIT` | — | `G0-6H-V1ETE`は[発注依存証跡](#発注依存証跡)で`DONE` | mechanics `V1G-P`、infrastructure `V1G-I`、capture `V1G-C`、immutable publication `V1G-O`へ分割 |
| VISUAL-RESPONSE | G0-6H-V1G-P | M3 evidence / VS-1 / current-route generation mechanics decision | `DO` | — | `G0-6H-V1ETE`は[発注依存証跡](#発注依存証跡)で`DONE` | 旧v1生成物を不変に保ち、V1G-I→V1G-C→V1G-Oの契約境界をdocs-onlyで閉じる |
| VISUAL-RESPONSE | G0-6H-V1G-I | M3 evidence / VS-1 / current-route manifest and fingerprint infrastructure | `WAIT` | — | `G0-6H-V1G-P`完了待ち | manifest v2と共有source fingerprint基盤だけを閉じる |
| VISUAL-RESPONSE | G0-6H-V1G-C | M3 evidence / VS-1 / current-route offline capture | `WAIT` | — | `G0-6H-V1G-I`完了待ち | 2 mode、5 normal、派生variant、provenance、offline captureを閉じる |
| VISUAL-RESPONSE | G0-6H-V1G-O | M3 evidence / VS-1 / current-route immutable publication | `WAIT` | — | `G0-6H-V1G-C`完了待ち | 別root manifestと30 PNGのimmutable publication/read-only照合を閉じる |
