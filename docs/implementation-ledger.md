...
| M5 | **`M5-A0T` / `M5-A1` / `M5-A2` / `M5-R0` / `M5-T0` / `M5-P0` / `M5-I0` / `M5-D0` DONE / `M5-A0S` DONE（docs-only）** | [M5-A1 receipt](reviews/evidence/m5-known-implementation/M5-A1/README.md)でGLB import leaf、[M5-A2 receipt](reviews/evidence/m5-known-implementation/M5-A2/README.md)でOBJ lowering／欠落診断、[M5-R0 receipt](reviews/evidence/m5-known-implementation/M5-R0/README.md)でwgpu offscreen route、[M5-T0 receipt](reviews/evidence/m5-known-implementation/M5-T0/README.md)でFontique＋HarfRust KEEPとParley private probe、[M5-P0 receipt](reviews/evidence/m5-known-implementation/M5-P0/README.md)でRoI／linear／quality algorithm contract、[M5-I0 receipt](reviews/evidence/m5-known-implementation/M5-I0/README.md)でobvhs／owned flat semantic一致とstale拒否、[M5-D0 receipt](reviews/evidence/m5-known-implementation/M5-D0/README.md)でstable mixer／PCG32 identity fixtureを確認した。[M5-A0S決定回収](reviews/2026-08-02-m5-a0s-decision-recovery.md)で後発7 blobを縮小採用／観察／棄却へ処分した。独立検証セットと意味回収は完了したが、製品text API／material／renderer／post／picking／Duplicator、PBR conformance、GPU pass／readback、3 OSは未実装。次は`M5-C0` ObservationとM4 resource gateをruntime前に閉じる |
