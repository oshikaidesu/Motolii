...
| PRODUCT-ASSET | CU-106P | M3 / VS-1 / B / primary selection consumer | `DO` | — | U3a-2入場範囲決定 + `CU-110PT` non-test Timeline caller | U2h-1P P5を内包。native Timeline pointer入力、存在拒否→no-op→枯渇preflightとproduction到達性を固定 |
