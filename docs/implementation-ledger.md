...
| 1c | CU-0G02B | M3 measure | `DO` | — | CU-0G02BH固定commitの既存二armを同一session・同一digestで再実測。CPU/GPU/RSS/resource/readback/toolchain/commitをtyped rawへ保存し、新renderer/profiler framework/製品telemetryなし | 完了後にCU-0G05LをDOへ戻す |
