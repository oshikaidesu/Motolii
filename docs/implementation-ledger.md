...
| VISUAL-RESPONSE | G0-6H-V1EB | M3 evidence / VS-1 / Browser development projection seam | `DO` | — | `G0-6H-V1R` R-7/R-11。decoder閉集合はpure test、入力なしDOM不変は既存Playwrightで判定 | product Browserの非公開development projection decoder/input seamとprovenance/guard再締結だけを閉じる。R-9実描画はV1ETへ |
| VISUAL-RESPONSE | G0-6H-V1ET | M3 evidence / VS-1 / mock empty projection and ready oracle | `WAIT` | — | `G0-6H-V1EB`完了待ち | Vite mode carrier、Browser R-9実描画、Stage/Inspector/Timeline空投影、ready oracleをroute-level Playwrightで閉じる |
