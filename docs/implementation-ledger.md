...
| VISUAL-RESPONSE | G0-6H-V1E | M3 evidence / VS-1 / screen-1 typed envelope projection | `DO` | — | `G0-6H-V1R`裁定 | typed envelope、screen 1空投影、ready oracle、通常route不変だけを閉じる |
| VISUAL-RESPONSE | G0-6H-V1G | M3 evidence / VS-1 / current-route immutable generation | `WAIT` | — | `G0-6H-V1E`完了待ち | 5 normal / 30 PNG、別root manifest、offline capture、read-only照合を閉じる |
