...
| M2 | **基盤再締結済み / D1n・D1l lint follow-up pending** | D1lのDocument／lifecycle意味、D3e、D1m、CAM-G0→D1j→D1k-S→D1k→D3fとA〜C証跡はmain発効済み。D1lの`new_v1` enforcementだけは2026-07-23監査で決定とlive codeのdrift（deprecated属性＋25 suppression）を確認しGAP-23で再開。D5は骨格到達・統合審判pending。D1n external revisionも未実装で、cloud-safe公約不可 |
