...
communityの発見、類似表現、人気、User library、Plugin Setのガバナンスは[Community distribution model](community-distribution-model.md)を正本とする。catalogは公式順位表ではなく地図、User libraryは日常の棚、Plugin Setは人へ渡す入口であり、package形式へ同居させない。
