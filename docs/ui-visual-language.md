...
視覚構成の基準は[高密度メインUIモック](mocks/m3-main-ui-v1.html)とする。HTMLはライト/ダークを実際に切り替えられ、[ライト静止画](mocks/m3-main-ui-v1-light.png)と[ダーク静止画](mocks/m3-main-ui-v1-dark.png)を比較証拠として固定する。モックにある未決機能は実装決定ではなく、画面密度のfixtureである。
...
- 右下またはstatus領域に、hover/focus中の操作について「何をするか」「shortcut」「現在の制約」を短く表示できる口を持つ。Blenderのcontext説明を先例にする
