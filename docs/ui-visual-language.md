...
この文書は操作モデルではなく、Motoliiの見た目と視覚認知の基準を定める。UI toolkit、Document意味論、入力契約は変更しない。実装境界は[M3 UI境界汚染の予防](reviews/2026-07-14-m3-ui-boundary-prevention.md)、タスクと審判は[M3仕様](specs/M3-ui-integration.md)を正本とする。
