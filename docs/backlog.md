...
| GAP-6 | 入力/ショートカット&アクセシビリティ(SlintのAccessKit、IME前提の入力設計) | 日本語IMEを一級にしたのに、キーマップ/a11yの土台が未計画 | 安定`CommandId`+press/release/click/drag+不変base/user delta+version/原本保全migrationを仕様化。v1 accessibility保証/非保証とkeyboard完結範囲を明記 | P2 | M3 G0-2/U0b〜U0d |
