...
- **M2出戻りガード(2026-07-12追記)**: 入場ゲート達成後も恒久スキーマへの早焼き出戻りが残る(H-4)。先人対応+LLMガードレール(GR-RW-1〜6)は[reviews/2026-07-12-rework-prior-art.md](reviews/2026-07-12-rework-prior-art.md)。運用入口は[AGENTS.md](../AGENTS.md)。
