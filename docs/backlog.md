...
- **フェーズ**: **凍結ゲート宣言済み**(2026-07-10)。骨格は解禁。**2026-07-12**: M2は再び**ドラフト＋発注停止** — [reviews/2026-07-12-M2-order-gate-halt.md](reviews/2026-07-12-M2-order-gate-halt.md)(入場ゲート全緑 ≠ 仕様確定)。
