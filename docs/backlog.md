...
| GAP-4 | **Undoの粒度/coalescing**(ドラッグ=多数コマンドの結合)+ジャーナル整合 | **決定済み**(#103⑨): プロパティ単位atomic、1 gesture=1 macro、同一対象+同一propertyのdragをmerge | D2(#109)のgesture merge+apply/revertプロパティテスト | P2 | **実装待ち** / M2-D2 |
