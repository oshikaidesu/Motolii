...
ステータス: **ドラフト**(凍結ゲートで確定。**2026-07-14**: 「楽曲1本」をM2実装範囲へ縮小し、音付き動画へ追加的に広げる[一般音声設計](../reviews/2026-07-14-audio-generalization-design.md)を決定。M2タスク追加なし。**2026-07-13**: [#103決定パック](../reviews/2026-07-13-decision-pack-adoption.md)・**PathOp意味論表【決定】**・残小項目(Undo/ExportJob/Group/audio)採択。以後は原則コード依頼+受入。**2026-07-12**: D1-prelude・色契約・LayerId・時刻serde・duration半開・D1再分割・補間/変形意味論)
