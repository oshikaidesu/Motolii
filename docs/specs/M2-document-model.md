...
着手条件: Wave1〜4の実装とP1修復(#153/#154)は main 到達済み。再締結中に着手できるM2作業は下表の依存と状態に従う。D3e、D1m、CAM-G0、D1j、D1k-S、D1kは完了済みで、次の camera 出口は D3f 実装。D5は新規発注ではなく、landed済み骨格の統合/E2E審判待ち。Transport方針【採択】正本=[先例調査](../reviews/2026-07-14-d5-transport-prior-art.md)。
