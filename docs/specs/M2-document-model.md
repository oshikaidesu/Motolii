...
着手条件: **タスク表の依存を満たした行から発注する**。Wave1(#126 D1f / #129 D4 / #130 D2)および#100・#101は**完了・main到達済み**。**D3(#110)・D1i-4(#107)・D1d(#105)完了**。現在の発注可: **D1e(#104)**・**D6**(D4完了により解除。Issue未整備可)。D1i-3(#108)は本線完了、D7はD3後、D5はD3+D4後。D1eはD1dと`persist`/公開エラー型で競合しやすいため後段。
...
| D1i-3 | **完了**(#108): **第二監査フォローアップ③c(S16)— 非PathOp演算の保護ゴールデン**: BlendMode / LookAt・Follow / Bezier solver / Transform合成の意味論ゴールデン。台帳=`classification.tsv`の semantic 行(本体更新禁止) | D3 | 各演算のゴールデンが存在し、意味を固定している |
