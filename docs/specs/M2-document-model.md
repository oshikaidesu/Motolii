...
ステータス: **段階発注可／M2基盤再締結済み**(旧コア締結宣言は**撤回** — [記録](../reviews/2026-07-14-m2-core-closure.md)。P1修復 #153/#154と再締結A〜C証跡はmain発効済み。D7(#145/#149)は維持。**D5(#144)骨格landed・統合/E2E審判pending**で、再締結の閉集合外。PP-GateはM3前追跡のまま)。M3製品実装はU0a入場完了後、各タスクの個別依存に従う。
着手条件: Wave1〜4、P1修復(#153/#154)、D3e、D1m、CAM-G0、D1j、D1k-S、D1k、D3fと再締結証跡はmain到達済み。後続M2作業は下表の依存と状態に従う。D5は新規発注ではなく、landed済み骨格の統合/E2E審判待ち。Transport方針【採択】正本=[先例調査](../reviews/2026-07-14-d5-transport-prior-art.md)。
...
- ~~CompCameraのv1採否/恒久意味~~ → **【決定】D1j〜D3f**(2026-07-16): 常在単一cameraを採択し、v1は`PlanarOrthographic`のみ。既存schema／pixelは不変とし、Spatial/Perspective以後は[Camera Object / Provider決定](../reviews/2026-07-24-camera-object-provider-decision.md)に基づくM5 P3へ延期
