...
着手条件: **タスク表の依存を満たした行から発注する**。Wave1(#126 D1f / #129 D4 / #130 D2)および#100・#101は**完了・main到達済み**。**D3(#110)完了**。現在の発注可: **D1i-4(#107)**・**D1d(#105)**・**D1e(#104)**・**D6**(D4完了により解除。Issue未整備可)。D1i-3/D7はD3後、D5はD3+D4後。D1eはD1dと`persist`/公開エラー型で競合しやすいため後段。
