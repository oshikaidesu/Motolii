...
着手条件: **タスク表の依存を満たした行から発注する**。現在、D2(#109)・D4(#123)は発注可。**D1i-2(#100)・D1cフォローアップ(#101)は完了・mainマージ済み**。D1f(#106)は**本PR・mainマージ待ち**。D1d(#105)・D1e(#104)は**発注可**(#101のResourceLimits/OpenModeはmain利用可)。D3(#110)は**D1i-2完了・mainマージ=第二凍結点により発注可**(D1i-4のCI施行はD1i-2完了により着手可)。D4はDocumentスキーマ非接触の独立レーン(D6はD4完了後)
