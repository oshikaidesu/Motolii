...
キーフレーム済みカラー量産後の解釈変更はマイグレーション不能な破壊になるため、D1着手前に3層を分離して固定する。
