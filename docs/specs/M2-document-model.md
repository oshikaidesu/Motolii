...
着手条件: **タスク表の依存を満たした行から発注する**。現在、D1cフォローアップ(#101)・D2(#109)・D1f(#106)・D4(#123)は発注可。**D1i-2(#100)は完了**(本PR)——D3(#110)は**本PRのmainマージ=第二凍結点**まで待つ(D1i-4のCI施行はD1i-2完了により着手可)。D1d(#105)・D1e(#104)は**#101完了・mainマージ**まで待つ。D4はDocumentスキーマ非接触の独立レーン(D6はD4完了後)
