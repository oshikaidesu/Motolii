...
ステータス: **段階発注可／M2基盤再締結ゲート発効中**(コア締結宣言は**撤回** — [記録](../reviews/2026-07-14-m2-core-closure.md)。P1修復 #153/#154 完了。D7(#145/#149)は維持。**D5(#144)骨格landed・統合/E2E審判pending**。PP-GateはM3前追跡のまま。再宣言は追補レビュー後)。M3製品実装は再締結解除と新しい入場PRまで停止する。
着手条件: Wave1〜4の実装とP1修復(#153/#154)は main 到達済み。再締結中に着手できるM2作業は下表の依存と状態に従う。D3e、D1m、CAM-G0、D1j、D1k-S、D1k、D3fは完了済み。D5は新規発注ではなく、landed済み骨格の統合/E2E審判待ち。Transport方針【採択】正本=[先例調査](../reviews/2026-07-14-d5-transport-prior-art.md)。
