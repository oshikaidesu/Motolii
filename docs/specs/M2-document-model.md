...
着手条件: **タスク表の依存を満たした行から発注する**。Wave1(#126 D1f / #129 D4 / #130 D2)および#100・#101は**完了・main到達済み**。**Wave2完了**: D3(#136/#110)・D1i-4(#134/#107)・D1d(#135/#105)。**Wave3**: D1i-3(#108/#139) は LookAt(D3回転契約)修正待ち・D1e(#104/#140) は TimeMap/backup 修正中。後段: **D6(#133)**・**D7**(Issue未整備)・**D5**(D3+D4後・Issue未整備)。
...
| D1i-3 | **進行中**(#108 / #139): **第二監査フォローアップ③c(S16)— 非PathOp演算の保護ゴールデン**: BlendMode / Follow / Bezier / Transform合成。**LookAtはD3フォローアップ(rotation角度)確定後にsemantic登録** — 誤ったposition/Vec2意味を永久固定しない | D3 | 各演算のゴールデンが存在し、意味を固定している。LookAtはconcept正本(`rotation=look_at`)と一致 |
