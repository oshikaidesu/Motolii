...
着手条件: **タスク表の依存を満たした行から発注する**。Wave1(#126 D1f / #129 D4 / #130 D2)および#100・#101は**完了・main到達済み**。**Wave2完了**: D3(#136/#110)・D1i-4(#134/#107)・D1d(#135/#105)。**Wave3**: **D1e(#104)完了**(本PR)。**D1i-3(#108)** は並列PR。後段: **D6(#133)**・**D7**(Issue未整備)・**D5**(D3+D4後・Issue未整備)。
