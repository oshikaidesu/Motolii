...
ステータス: **段階発注可**(コア締結宣言は**撤回** — [記録](../reviews/2026-07-14-m2-core-closure.md)。P1修復 #153/#154 完了。D7(#145/#149)は維持。**D5(#144)完了**。PP-GateはM3前追跡のまま。再宣言は追補レビュー後)。
