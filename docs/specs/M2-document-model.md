...
| AG-2 | 未着手(#157): per-stream PCM cacheと決定論的mixer | AG-1 | 設計§6/Issue完了条件 |
| AG-3 | 未着手(#158): import・waveform・mute/gain・音声分離UI | AG-1, AG-2 | 設計§7/Issue完了条件 |
| AG-4 | 未着手(#159): stream-copy fast pathとmixed PCM export | AG-1, AG-2 | 設計§6.3/Issue完了条件 |
| AG-5 | 追跡のみ(#160): fade/pan/role/bus/effect/pitch preserve | AG-1〜4後に個別判断 | 一括実装禁止 |
