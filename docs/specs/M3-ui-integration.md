...
| G0-9L | 主開発Macのlocal platform prerequisite evidence gate | **CU-0G02〜04完了 / CU-0G05L判定中** | [段階化決定](../reviews/2026-07-23-m3-g0-9-staged-platform-gates.md)の固定Mac構成で、同条件renderer比較、実IME/VoiceOver/focus、100回resize、capture、注入Surface lost、WKWebView content process実終了/reload、offline既定拒否とstale epoch拒否は合格済み。次のCU-0G05Lで反対側reviewと限定確定を行うまでG0-9L PASSを宣言しない。W0b、H1b、Motolii Studio Preview、window結合、G0-6H、G0-3/GAP-13は解禁・PASS・省略・迂回しない |
