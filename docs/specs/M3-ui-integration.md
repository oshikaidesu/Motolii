...
| G0-9L | 主開発Macのlocal product integration gate | **仕様改訂案 / 反対側レビュー・実機審判待ち** | [段階化改訂案](../reviews/2026-07-23-m3-g0-9-staged-platform-gates.md)の固定Mac構成で、同条件renderer比較、実IME/VoiceOver/focus、100回resize、capture、Surface lost、WKWebView content process crash、offlineとstale epoch拒否を一つのmanifestへ閉じる。P0/P1=0と実機合格後、そのMac構成だけW0bを解禁する。それまではWebView/native製品統合を停止する |
