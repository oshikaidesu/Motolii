...
| G0-9L | 主開発Macのlocal platform prerequisite evidence gate | **CU-0G02B完了 / CU-0G05L再検収待ち** | CU-0G05L反対側reviewで検出したL1三arm文言ドリフトは、[L1正本修正](../reviews/2026-07-24-m3-g0-9l-l1-measurement-amendment.md)を候補stack対egui baselineへ確定した。GPU raw不足はCU-0G02BHのbounded wgpu query harnessとCU-0G02Bの同一session再実測で閉じ、Grok P0/P1=0でACCEPTした。既存CU-0G02のCPU/input/RSS rawは保持するが、CU-0G05Lの再検収と限定確定までG0-9L PASSを宣言しない。W0b、H1b、Motolii Studio Preview、window結合、G0-6H、G0-3/GAP-13は解禁・PASS・省略・迂回しない |
