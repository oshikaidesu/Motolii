...
| GR-UI-8 視覚認知 | U0e, U1f, U1h, U1i, U2d, U2e, U2f, U2g, U2h, U3d, U3e, U3f, U4a, U4c, U5, U6 | token生成差分、Dark/Light×通常/高コントラストstate matrix、Output Frame/Stage View/Camera/pressure warning/activity/selection/filtered selection/readiness/target-pick/Relative HUD/from-in接続状態、raw color、contrast、icon/state、通常+lightness/CVD reference画像 | 5秒識別、高コントラスト時の境界/focus/selection/disabled/warning、frame内外/Camera対Hand/pressure理由/activity/selection/readiness/通常drag対Relative/from対in、grayscale/CVD、既存UIとの馴染み |
