...
8. **出戻り防止(恒久スキーマ)**: Documentスキーマ/ジャーナル/意味論ゴールデンに触るタスクは、着手前に[AGENTS.md](../../AGENTS.md)「出戻り防止」のGR-RWチェックと[reviews/2026-07-12-rework-prior-art.md](../reviews/2026-07-12-rework-prior-art.md)を読む。**テスト緑≠完了**(意味論表・決定の逆リンクが無い「完了」宣言は禁止 — [pitfalls H-4](../pitfalls-and-roadmap.md))。
