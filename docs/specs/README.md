...
| [M3-ui-integration.md](M3-ui-integration.md) | **ドラフト / UI責任境界決定・surface統合比較中**(React chrome + native Stage/Timeline + headless interactionは決定。WebView/native製品統合とplugin公開契約はG0-9実機待ち) |
