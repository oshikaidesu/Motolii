...
| [M5-3d-and-post.md](M5-3d-and-post.md) | ドラフト(P0I/P7は別gate)。P2D Render Contributionの**意味設計**は[締結地図](../reviews/2026-07-29-m5-render-contribution-design-closure-map.md)§2まで完了。public seam／resource method／実装完了は同地図§3〜§8とledgerの依存に従う |
