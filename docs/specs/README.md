...
| [M2-document-model.md](M2-document-model.md) | **段階発注可**(Wave2 #134/#135/#136 main到達。**Wave3**: #108 D1i-3 完了 / #104 D1e 本線継続。後段: #133 D6 / D7 / D5) || [M3-ui-integration.md](M3-ui-integration.md) | ドラフト(M0-S1の採否判断で確定) |
