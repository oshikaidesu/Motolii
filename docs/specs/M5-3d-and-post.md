...
| P2D-RCA7 | 固定Motolii境界fragment ID配置 | P2D-RC0, P2D-RCE0, GR-D4 | 登録済み。runner所有操作を依頼本文へ列挙せず、18 cell copyだけ |
| P2D-RCI | 新しい証拠grainの統合とRender Contribution最終decision。必要ならcontract／private spike／schema／First Vism fixtureを再分割 | P2D-RCA7, P2D-RCB5, P2D-RCC5 | **WAIT**。Motolii authorityを正として統合し、公開境界または永続意味が未決なら実装解禁せずSTOP |
