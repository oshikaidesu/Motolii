...
| P1 | glTF読み込み(メッシュ・マテリアル最小限)+ OBJ→glTF変換パス | 凍結ゲート。[M5-A1 private probe](../reviews/evidence/m5-known-implementation/M5-A1/README.md)は`gltf`／`mikktspace`をKEEPしたが製品依存・Importerは未実装 | サンプルアセットの読み込みゴールデンテスト |
