...
const panelWayfindingRoles = {
  project: "var(--motolii-color-way-project)",
  files: "var(--motolii-color-way-files)",
  plugins: "var(--motolii-color-way-plugins)",
  stage: "var(--motolii-color-way-stage)",
  inspector: "var(--motolii-color-way-inspector)",
  timeline: "var(--motolii-color-way-timeline)",
};
