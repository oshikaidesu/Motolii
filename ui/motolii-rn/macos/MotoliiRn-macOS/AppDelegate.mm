...
- (NSDictionary<NSString *, Class<RCTComponentViewProtocol>> *)thirdPartyFabricComponents
{
  ...
  components[@"MotoliiBrowserDragSourceView"] = MotoliiBrowserDragSourceComponentView.class;
...
- (void)createMotoliiHostOnce
{
  ...
  [MotoliiSnapshotChannel bindHostHandle:hostHandle];
...
- (void)applicationWillTerminate:(NSNotification *)notification
{
  if (self.motoliiHostHandle != 0) {
    [MotoliiSnapshotChannel unbindHostHandle:self.motoliiHostHandle];
