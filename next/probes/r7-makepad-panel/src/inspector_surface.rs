...
//! 面 #x4f4f4f / 窪み #x141414 / 帯 #x646464 / 選択帯 #x8dc9d9 / 墨 #x171717 /
//! 値シアン #x73acb3 / 線シアン #x8dc9d9 / 橙 #xd99b44 / ボタン #x393939+#xe3e3e5 /
//! 指針 #xd6d0d4 / 境界 #x1c1c1c。
...
script_mod! {
    ...
    // 1px 区切り線 — Device 境界の実測 #x1c1c1c
    let InspectorRule = SolidView{width: Fill height: 1 show_bg: true new_batch: true draw_bg.color: #x1c1c1c}
    ...
    mod.widgets.InspectorSurface = set_type_default() do mod.widgets.InspectorSurfaceBase{
        ...
        inspector_head := SolidView{width: Fill height: 20 flow: Right spacing: 6 align: Align{y: 0.5} padding: Inset{left: 6 right: 8} show_bg: true new_batch: true draw_bg.color: #x8dc9d9
            accent_dot := SolidView{width: 7 height: 7 show_bg: true draw_bg.color: #xd99b44 draw_bg.border_radius: 3.5}
        ...
        // モード切替 = Peak/RMS 型セグメント。オンは橙+墨字、オフは #x393939+明字。隙間 1px が線
        modes := SolidView{width: Fill height: 22 flow: Right spacing: 1 show_bg: true new_batch: true draw_bg.color: #x1c1c1c
            effect := ButtonFlat{text: "Effect" width: Fill height: 22 icon_walk: Walk{width: 11 height: 11} draw_icon +: {svg: crate_resource("self://resources/icons/effects.svg") color: #x171717} draw_bg.color: #xd99b44 draw_bg.color_hover: #xd8a160 draw_bg.color_down: #xbf8d4e draw_bg.border_size: 0.0 draw_bg.border_radius: 0.0 draw_text.color: #x171717 draw_text.text_style: theme.font_bold{font_size: 8}}
            layer_mode := ButtonFlat{text: "Custom" width: Fill height: 22 icon_walk: Walk{width: 11 height: 11} draw_icon +: {svg: crate_resource("self://resources/icons/shape.svg") color: #xe3e3e5} draw_bg.color: #x393939 draw_bg.color_hover: #x424242 draw_bg.color_down: #x141414 draw_bg.border_size: 0.0 draw_bg.border_radius: 0.0 draw_text.color: #xe3e3e5 draw_text.text_style: theme.font_regular{font_size: 8}}
        }
        modes_rule := InspectorRule{}

        // 選択 = 面の上に窪み表示欄。名はシアン、種別は琥珀（kHz 表示の実測）
        selection := SolidView{width: Fill height: 40 flow: Right spacing: 6 align: Align{y: 0.5} padding: Inset{left: 6 right: 6} show_bg: true new_batch: true draw_bg.color: #x4f4f4f
            glyph := Icon{width: 20 height: 20 icon_walk: Walk{width: 13 height: 13} draw_icon +: {svg: crate_resource("self://resources/icons/shape.svg") color: #x171717} draw_bg +: {color: #xd99b44}}
            ...
            mute := ButtonFlatIcon{width: 20 height: 20 padding: 0 icon_walk: Walk{width: 11 height: 11} draw_bg.color: #x393939 draw_bg.color_hover: #x424242 draw_bg.color_down: #x141414 draw_bg.border_size: 0.0 draw_bg.border_radius: 0.0 draw_icon +: {svg: crate_resource("self://resources/icons/mute.svg") color: #xe3e3e5}}
            solo := ButtonFlatIcon{width: 20 height: 20 padding: 0 icon_walk: Walk{width: 11 height: 11} draw_bg.color: #xd99b44 draw_bg.color_hover: #xd8a160 draw_bg.color_down: #xbf8d4e draw_bg.border_size: 0.0 draw_bg.border_radius: 0.0 draw_icon +: {svg: crate_resource("self://resources/icons/solo.svg") color: #x171717}}
        }
        ...
        columns := SolidView{width: Fill height: 15 flow: Right spacing: 3 align: Align{y: 0.5} padding: Inset{left: 8 right: 8} show_bg: true new_batch: true draw_bg.color: #x4f4f4f
        ...
        property_rows := SolidView{width: Fill height: Fill flow: Down show_bg: true new_batch: true draw_bg.color: #x4f4f4f
            position_row := SolidView{width: Fill height: 22 flow: Right spacing: 3 align: Align{y: 0.5} padding: Inset{left: 8 right: 8} show_bg: true new_batch: true draw_bg.color: #x4f4f4f
                ...
                key := InspectorKey{draw_icon +: {color: #xd99b44}}
            }
            scale_row := SolidView{width: Fill height: 22 flow: Right spacing: 3 align: Align{y: 0.5} padding: Inset{left: 8 right: 8} show_bg: true new_batch: true draw_bg.color: #x4f4f4f
            ...
            rotation_row := SolidView{width: Fill height: 22 flow: Right spacing: 3 align: Align{y: 0.5} padding: Inset{left: 8 right: 8} show_bg: true new_batch: true draw_bg.color: #x4f4f4f
        ...
        knob_strip := SolidView{width: Fill height: 56 flow: Right show_bg: true new_batch: true draw_bg.color: #x4f4f4f
            ...
            knob_divider := SolidView{width: 1 height: Fill show_bg: true draw_bg.color: #x1c1c1c}
