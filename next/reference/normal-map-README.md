...
## 判定結果(2026-08-21、J1〜J3 適用済み — 未判定0)

- **採用済 92 / 採用予定 1,195 / 不採用 264**(計1,551、重複判定39件の衝突11件は J1=編集核専門・厳格側を優先)
- 採用予定の freq 分布: freq4=3(Copy/Paste/New Project)・freq3=14・freq2=25・freq1=1,153
- **最優先キュー= freq≥2 の採用予定 42件**(Copy/Paste・Split・Cut/Duplicate/Select All・Play-Pause/Step・In-Out マーカー族・Effects/Info パネル・ショートカットエディタ等)
- 不採用 264 の主な型: trim family 38・Fusion ノード29・グレーディングスイート級57・プリコンポ系・VST・立体視・生成AI(素材新規生成のみ — 解析変換系は採用予定側)・リアルタイム共同編集(single-writer と構造衝突)
