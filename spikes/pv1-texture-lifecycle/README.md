...
**状態: PV-1 pass（Apple M4 / Metal）/ DX12・Vulkan pending**
...
`docs/spikes/pv1-texture-lifecycle.md` の H1–H5をApple M4 / Metalで実測済み。H6は単一monitor環境のため適用外。証跡 JSON のoverallは人間審判後にのみpassとし、自動試験だけではpassにしない。
...
Backend: Metal pass / DX12・Vulkan pending。
