...
pub use journal::{
    ...
    inject_orphan_snapshot_after_first_frame, inject_restore_attempted_marker,
    inject_salt_mismatch_frame, load_catalog, open_project, quarantine_dir_for_document,
    restore_attempted_path_for_document, save_project_with_journal, scan_journal,
    GenerationCatalog, GenerationEntry, JournalEdit, JournalFrame, JournalHeader,
